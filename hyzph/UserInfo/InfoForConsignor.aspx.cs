    ...
    public partial class InfoForConsignor : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //查询货主信息
                sql =
                    string.Format(@"select b.username,b.identity_card,b.auditmark_identity,b.auditmark_postcard,a.account,a.logogram
                ...
                else
                {
                    ...
                    info.Add("Mobile", dt.Rows[0]["account"].ToString());
                    info.Add("Logogram", dt.Rows[0]["logogram"].ToString());
                }
